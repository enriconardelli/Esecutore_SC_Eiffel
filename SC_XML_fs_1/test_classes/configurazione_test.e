...
feature -- Test
	...
	do
			assert("non ha alfa", configurazione_prova.variabili_booleane.has ("alfa"))
			assert("non ha beta", configurazione_prova.variabili_booleane.has ("beta"))
			assert("non ha gamma", configurazione_prova.variabili_booleane.has ("gamma"))
	end
	...
	do
			assert("non ha running$value",  altra_configurazione_prova.variabili_booleane.has ("running$value"))
			assert("non ha paused$value", altra_configurazione_prova.variabili_booleane.has ("paused$value"))
			assert("non ha stopped$value", altra_configurazione_prova.variabili_booleane.has ("stopped$value"))
			assert("non ha reset$value", altra_configurazione_prova.variabili_booleane.has ("reset$value"))
	end
