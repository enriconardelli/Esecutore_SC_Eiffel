...
feature --test
	...
	t_costrutto_merge_1_ter
			-- EN, 18/09/2021
		do
			conf_finale.force ("A1")
			conf_finale.force ("B1")
			evoluzione_state_chart ("costrutto_merge_1_ter.xml", "costrutto_merge_eventi_con_merge.txt", conf_finale)
		end
	...
	t_costrutto_merge_non_ammissibile
		...
		do
			...
			assert ("ERRORE il sistema non riconosce che la configurazione di stati non è ammissibile per il costrutto merge", esecutore.state_chart.errore_costruzione_SC/=0)
		end
