...
feature -- Test
	...
	t_base_parallelo
		...
		do
			...
			assert ("ERRORE il sistema non ha terminato negli stati corretti ( A - TRE )", esecutore.conf_corrente.count = 2 and conf_has_state(esecutore.conf_corrente,"C") and conf_has_state(esecutore.conf_corrente,"TRE") )
		end
	...
	t_condizioni_parallelo
		...
		do
			...
			create esecutore.make (nomi_files_prova)
			assert ("ERRORE il sistema non ha terminato negli stati corretti ( C - DUE )", esecutore.conf_corrente.count = 2 and conf_has_state(esecutore.conf_corrente,"DUE") and conf_has_state(esecutore.conf_corrente,"C") )
	...
	-- La transizione ha come target lo stato AND
		...
		do
			...
			create esecutore.make (nomi_files_prova)
			assert ("ERRORE il sistema non ha terminato negli stati corretti ( A2A1 - A2B1 )", esecutore.conf_corrente.count = 2 and conf_has_state(esecutore.conf_corrente,"A2A1") and conf_has_state(esecutore.conf_corrente,"A2B1") )
		end
	...
	-- La transizione ha come target un sotto-stato dello stato AND
		...
		do
			...
			create esecutore.make (nomi_files_prova)
			assert ("ERRORE il sistema non ha terminato negli stati corretti ( A2A2 - A2B1 )", esecutore.conf_corrente.count = 2 and conf_has_state(esecutore.conf_corrente,"A2A2") and conf_has_state(esecutore.conf_corrente,"A2B1") )
		end
	...
	-- La transizione esce da un sotto-stato dello stato AND
		...
		do
			...
			create esecutore.make (nomi_files_prova)
			assert ("ERRORE il sistema non ha terminato negli stati corretti ( A1 )", esecutore.conf_corrente.count = 1 and conf_has_state(esecutore.conf_corrente,"A1") )
		end
