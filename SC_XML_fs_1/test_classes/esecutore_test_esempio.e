...
feature -- Test routines
	...
	on_prepare
		do
		    precursor
			nomi_files_prova[1] := test_data_dir + "sc_tre_stati_atomici.xml"
 ...
 feature -- Test "Esempio"
	...
	t_esempio_1
		...
		local
			esecutore: ESECUTORE
		do
			nomi_files_prova[2] := nomi_files_prova[2] + "e_tre_stati_atomici_1.txt"
	...
	t_esempio_2
		...
		local
			esecutore: ESECUTORE
		do
			nomi_files_prova[2] := nomi_files_prova[2] + "e_tre_stati_atomici_2.txt"
			create esecutore.make(nomi_files_prova)
	...
	t_esempio_3
		...
		local
			esecutore: ESECUTORE
		do
			nomi_files_prova[2] := nomi_files_prova[2] + "e_tre_stati_atomici_3.txt"
			create esecutore.make(nomi_files_prova)
			assert ("ERRORE il sistema non ha terminato nello stato corretto (one)", esecutore.conf_base_corrente.count = 1 and esecutore.conf_base_corrente[1].id.is_equal ("one") )
	...
	t_esempio_4
		...
		local
			esecutore: ESECUTORE
		do
			nomi_files_prova[2] := nomi_files_prova[2] + "e_tre_stati_atomici_4.txt"
			create esecutore.make(nomi_files_prova)
			assert ("ERRORE il sistema non ha terminato nello stato corretto (one)", esecutore.conf_base_corrente.count = 1 and esecutore.conf_base_corrente[1].id.is_equal ("one") )
	...
	t_esempio_5
		...
		local
			esecutore: ESECUTORE
		do
			nomi_files_prova[2] := nomi_files_prova[2] + "e_tre_stati_atomici_5.txt"
			create esecutore.make(nomi_files_prova)
			assert ("ERRORE il sistema non ha terminato nello stato corretto (one)", esecutore.conf_base_corrente.count = 1 and esecutore.conf_base_corrente[1].id.is_equal ("one") )
			assert ("ERRORE il sistema non ha aggiornato alfa", not esecutore.state_chart.condizioni.item ("alfa") )
	...
	t_esempio_6
		...
		local
			esecutore: ESECUTORE
		do
			nomi_files_prova[2] := nomi_files_prova[2] + "e_tre_stati_atomici_6.txt"
			create esecutore.make(nomi_files_prova)
			assert ("ERRORE il sistema non ha terminato nello stato corretto (one)", esecutore.conf_base_corrente.count = 1 and esecutore.conf_base_corrente[1].id.is_equal ("one") )
			assert ("ERRORE il sistema non ha aggiornato alfa", not esecutore.state_chart.condizioni.item ("alfa") )
			assert ("ERRORE il sistema non ha aggiornato beta", not esecutore.state_chart.condizioni.item ("beta") )
