...
feature -- Test
    ...
    do
      ...
      assert("ERRORE 5.5: lo stato di arrivo non è Y", conf_has_state(esecutore.state_chart.conf_base,"Y"))
    end
		...
		do
  		...
  		nomi_files_prova [2] := test_data_dir + "entrata_azioni_2_eventi.txt"
			...
			assert ("ERRORE 3.4 il sistema ha eseguito l'azione on_entryA2A1 che è lo stato di default", not esecutore.state_chart.variabili.booleane.item ("on_entryA2A1"))
		...
		do
			...
			create esecutore.make (nomi_files_prova)
			assert("Errore 1: lo stato di arrivo non è T", conf_has_state(esecutore.state_chart.conf_base,"T"))
	...
	t_azioni_con_interi_2_1
		...
		do
			...
			assert("ERRORE: M � diverso da 3",  esecutore.state_chart.variabili.intere.item ("M") = 0)
     		assert("ERRORE: N � diverso da 0", esecutore.state_chart.variabili.intere.item ("N") = -1)
		end
	...
	t_azioni_con_interi_2_2
		...
		do
			...
			assert("ERRORE: M � diverso da 6",  esecutore.state_chart.variabili.intere.item ("M") = 6)
     		assert("ERRORE: N � diverso da 2", esecutore.state_chart.variabili.intere.item ("N") = 2)
		end
	...
	t_azioni_con_interi_2_3
		...
		do
			...
			assert("ERRORE: M � diverso da 8",  esecutore.state_chart.variabili.intere.item ("M") = 8)
     		assert("ERRORE: N � diverso da 1", esecutore.state_chart.variabili.intere.item ("N") = 1)
		end
	...
	t_azioni_con_interi_3_1
		...
		do
			...
			create esecutore.make (nomi_files_prova)
			assert("ERRORE: il sistema non termina in (D)", conf_has_state(esecutore.state_chart.conf_base,"D"))
			assert("ERRORE: M � diverso da 3",  esecutore.state_chart.variabili.intere.item ("M") = 3)
     		assert("ERRORE: L � diverso da 10", esecutore.state_chart.variabili.intere.item ("L") = 10)
     		assert("ERRORE: K � diverso da true", esecutore.state_chart.variabili.booleane.item ("K"))
		end
	...
	t_azioni_con_interi_3_2
		...
		do
			...
			assert("ERRORE: M � diverso da 3",  esecutore.state_chart.variabili.intere.item ("M") = 3)
     		assert("ERRORE: L � diverso da 3", esecutore.state_chart.variabili.intere.item ("L") = 3)
     		assert("ERRORE: K � diverso da false", not esecutore.state_chart.variabili.booleane.item ("K"))
		end
	...
	t_azioni_con_interi_3_variazione_2
		...
		do
			...
			create esecutore.make (nomi_files_prova)
			assert("ERRORE: il sistema non termina in (C)", conf_has_state(esecutore.state_chart.conf_base,"C"))
			assert("ERRORE: M � diverso da 4",  esecutore.state_chart.variabili.intere.item ("M") = 4)
     		assert("ERRORE: L � diverso da 3", esecutore.state_chart.variabili.intere.item ("L") = 3)
     		assert("ERRORE: K � diverso da true",  esecutore.state_chart.variabili.booleane.item ("K"))
		end
